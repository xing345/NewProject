...
| 分类 | 数量 | 规格 | 内容 |
|------|------|------|------|
| 地砖 tiles | 90 | 48x48 + 16x16 | 主地砖、废土、赛博、箱子、装饰物、传送门等 |
| 角色 characters | 54 | 64x64 / ~49x43 / 16x16 | 主角色、杀手、蓝衣人、机器人、士兵、僵尸、守卫、小孩 |
| 武器道具 items | 35 | 16x16 | 光球、冲刺条、飞船、强化、吹箭、阴影等 |
| 特效 fx | 33 | 16x16 | 激光、激光弹、烟雾、碎片、粒子 |
| **合计** | **212** | | |
